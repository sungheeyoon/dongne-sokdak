-- get_profile_with_stats RPC가 stats.joined_at을 빠뜨려 매 호출마다
-- 응답 검증(ResponseValidationError, Profile.stats.joined_at required)에 실패하던 문제 수정.
-- 20260508_get_profile_with_stats.sql 작성 당시 누락됐다.
...
BEGIN
    ...
    RETURN json_build_object(
        ...
        'stats', json_build_object(
            ...
            'vote_count', vote_cnt,
            'joined_at', profile_record.created_at
        )
    );
END;
