"""Deterministic bounds inputs shared by the load scenario and its tests."""
...
def bounds_case_at(
    ...
    normalized_worker_count = max(worker_count, 1)
    case_index = worker_index + sequence * normalized_worker_count
    return BOUNDS_CASES[case_index % len(BOUNDS_CASES)]
